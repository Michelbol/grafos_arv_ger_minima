...
public class Vertice implements Comparator<Vertice>{
    ...
    private List<Vertice> adjacentes_prim;
    ...
    private boolean isImprimido;

    public List<Vertice> getAdjacentes_prim() {
        return adjacentes_prim;
    }

    public void setAdjacentes_prim(List<Vertice> adjacentes_prim) {
        this.adjacentes_prim = adjacentes_prim;
    }
    ...
    public boolean isIsImprimido() {
        return isImprimido;
    }

    public void setIsImprimido(boolean isImprimido) {
        this.isImprimido = isImprimido;
    }

    public void setCoordenadaX(int coordenadaX) {
        this.coordenadaX = coordenadaX;
    }
    public int getCoordenadaXquadrado() {
        return (int) Math.pow((double) coordenadaX, (double) 2);
    }
    ...
    public int getCoordenadaYquadrado() {
        return (int) Math.pow((double) coordenadaY, (double) 2);
    }
    ...
    public Vertice(String nome) {
        ...
        this.nome = nome;
        this.isImprimido = false;
    }

    public Vertice(String nome, int coordenadaX, int coordenadaY) {
        this.nome = nome;
        this.coordenadaX = coordenadaX;
        this.coordenadaY = coordenadaY;
        this.isImprimido = false;
...
//        System.out.println("Não são adjacentes");
    ...
    public String toString() {
        return "Vertice{" + "nome=" + nome +" coordx="+ coordenadaX+" isImprimido="+isImprimido+"}\n";
    }
    ...
    public void addAdjacente2(Vertice v){
        if(this.getAdjacentes_prim() == null){
            this.setAdjacentes_prim(new ArrayList<Vertice>());
        }
        List adjacente = this.getAdjacentes_prim();
        adjacente.add(v);
        this.setAdjacentes_prim(adjacente);
    }
